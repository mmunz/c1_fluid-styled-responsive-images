...
namespace C1\FluidStyledResponsiveImages\DataProcessing;
...
/**
 * Class for data processing for the content element "c1_fluid_styled_responsive_images"
 */
class FluidStyledResponsiveImagesProcessor implements DataProcessorInterface {
    ...
    protected function getConfiguration() {
        ...
        $this->settings = is_array($settings['plugin']['tx_c1fluidstyledresponsiveimages']['settings']) ? $settings['plugin']['tx_c1fluidstyledresponsiveimages']['settings'] : [];
    }

    /**
     * Process data for the content element "c1_fluid_styled_responsive_images"
     *
